#!/usr/bin/env python3
"""
Utrecht FSI 95% Experiment.

This experiment focuses on the top 5% densest urban areas in Utrecht,
...
# Data Selection
CITY_NAME = "utrecht"              # City/region to process
...
WANDB_PROJECT = None               # Set to string to enable WandB logging (e.g., "urban-utrecht")
...
def main():
    """Run the Utrecht FSI 95% experiment."""
    
    print("="*60)
    print("UTRECHT FSI 95% EXPERIMENT")
    print("="*60)
    ...
    try:
        ...
        logger.info("\n[CONFIG] UTRECHT FSI 95% EXPERIMENT CONFIGURATION:")
        ...
        logger.info("[RUN] Running Utrecht FSI 95% experiment...")
        embeddings = pipeline.run()
        
        if embeddings:
            logger.info("\n[SUCCESS] Utrecht FSI 95% experiment completed!")
