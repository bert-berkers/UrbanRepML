...
from modalities.alphaearth.processor import AlphaEarthProcessor

# Set up comprehensive logging
def setup_logging():
    """Setup detailed logging for resolution 10 processing embeddings."""
...
def save_processed_data(gdf, processing_duration, logger):
    ...
    output_dir = Path('data/processed/embeddings/alphaearth')
...
def main():
    ...
    try:
        ...
        # Update processing embeddings log
...
def update_processing_log(hexagon_count, duration, validation_passed, logger):
    """Update the processing embeddings log with this session's results."""
    
    try:
        # Read current processing embeddings log
...
- **Output file**: `data/processed/embeddings/alphaearth/netherlands_res10_2022.parquet`
...
"""
        ...
        logger.info(f"Updated processing embeddings log: {log_file}")
        
    except Exception as e:
        logger.warning(f"Failed to update processing embeddings log: {e}")
