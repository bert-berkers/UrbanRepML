"""
Test multi-modal pipeline with all available stage1_modalities.
"""
...
from stage2_fusion.multimodal_loader import MultiModalLoader
...
def test_pipeline():
    ...
    # Test 1: Load stage1_modalities
    logger.info("\n=== TEST 1: Loading Modalities ===")
    modalities = loader.load_all_modalities()
    
    if not modalities:
        logger.error("No stage1_modalities loaded!")
        return False
    ...
    output_dir = Path("data/study_areas/netherlands/stage2_fusion/multimodal")
    ...
    if output_path.exists():
        ...
        logger.info("✓ All stage3_analysis passed!")
        return True
    else:
...
def check_prerequisites():
    ...
    required_files = [
        ...
        "data/study_areas/netherlands/embeddings/alphaearth/alphaearth_embeddings_res10.parquet",
        "data/study_areas/netherlands/embeddings/poi/poi_embeddings_res10.parquet",
    ...
    roads_path = Path("data/study_areas/netherlands/embeddings/roads/roads_embeddings_res10.parquet")
