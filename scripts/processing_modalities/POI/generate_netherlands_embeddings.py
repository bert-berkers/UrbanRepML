...
def check_alphaearth_compatibility():
    ...
    alphaearth_path = Path("data/study_areas/netherlands/embeddings/alphaearth/netherlands_res10_2022.parquet")
...
def generate_poi_embeddings(boundary_gdf):
    ...
    # Configure POI processor for GPU-optimized processing_modalities
    poi_config = {
        'data_source': 'osm_online',
        'output_dir': 'data/study_areas/netherlands/embeddings/poi',
        ...
        # Save intermediate embeddings stage1_modalities data for debugging
        'save_intermediate': True,
        'intermediate_dir': 'data/study_areas/netherlands/embeddings/intermediate/poi'
    }
