...
from stage2_fusion.hexagonal_graph_constructor import HexagonalLatticeConstructor
...
def compute_accessibility_graph(
    ...
    """Compute accessibility graph with batch processing_modalities."""
        ...
        try:
            if args.graph_type in ['hexagonal', 'hexagonal_lattice']:
                ...
                hexagonal_constructor = HexagonalLatticeConstructor(
                    device='cpu',  # Use CPU for preprocessing_auxiliary_data
