"""
⚠️ LEGACY MODULE - DO NOT USE IN NEW CODE ⚠️

This module is DEPRECATED and kept for reference only.

USE INSTEAD: hexagonal_graph_constructor.py
  - Includes Phase 4 geometric optimizations (2-5x speedup)
  - SRAI batch neighborhood queries
  - Geometric validation against H3 formulas
  - Actively maintained and tested

This legacy module predates:
  - Hierarchical cone system optimizations
  - SRAI-based batch operations
  - Geometric pre-allocation strategies

Last Active: Pre-October 2025
Superseded By: HexagonalLatticeConstructor (hexagonal_graph_constructor.py)
Geometric Optimizations: See GEOMETRIC_OPTIMIZATIONS.md Phase 4
"""
